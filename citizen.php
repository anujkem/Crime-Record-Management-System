        ...
        <div class="row text-white" id="welcomeBody">
         ...
         $dbname = "paisashu_crms";
                ...
                else
                {
                    ...
                    echo "<table>";
                    echo "<tr><th>Name</th><th>Age</th><th>Adhaar Number</th><th>Phone</th><th>Gender</th><th>Address</th><th>Qualification</th></tr>";
                       while($row2 = $result2->fetch_assoc())
                       {   //Creates a loop to loop through results
                           
                        echo "<tr><td>" .$row2['Name'] . "</td><td>" .$row2['Age'] . "</td><td>" .$row2['Adhaar'] . "</td><td>" .$row2['Phone'] . "</td><td>" .$row2['Gender'] . "</td><td>" .$row2['Address'] . "</td><td>" .$row2['Qualification'] . "</td></tr>";  
                            }
