                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active bg-dark ms-2 rounded-pill" href="assigned.php">Assigned cases</a>
                                </li>
                ...
                else
                {
                    ...
                    if(mysqli_num_rows($result) > 0)
                    {
                        while($row1 = mysqli_fetch_assoc($result))
                        {
                            ...
                            <div class="col-12 text-white text-center border-bottom border-light mb-3">
                                <div class="row">

                                    <div class="col-12 p-2 text-left criminalDetails">
                                    ...
                                    <div class="col-12 p-2 crtext-left iminalDetails">
                                        <span>Closing Date - <?php echo ($row1["Closing Date"]) ? ($row1["Closing Date"]):("Not closed yet!"); ?></span>                                        
                                    </div>

                                    <div class="col-6 p-2 text-left criminalDetails">
