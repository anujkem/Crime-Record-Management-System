    ...
    <div class="container-fluid bg-black">
        ...
        <div class="row text-white" id="welcomeBody">
            ...
            <?php
                ...
                {
                    $sql2 = "SELECT P.Name,P.Age,P.Adhaar,C.CriminalID,C.CrimeID,C.Reward,C.PriorityStatus FROm criminal C, person P WHERE P.Adhaar = C.Adhaar";
                    $result2 = $conn->query($sql2);
                      
                    echo "<table>"; // start a table tag in the HTML
                    echo "<tr><th>Name</th><th>Age</th><th>Adhaar Number</th><th>Criminal ID</th><th>Reward</th><th>Priority Status</th></tr>";
                       while($row2 = $result2->fetch_assoc())
                       {   //Creates a loop to loop through results
                           
                        echo "<tr><td>" .$row2['Name'] . "</td><td>" .$row2['Age'] . "</td><td>" .$row2['Adhaar'] . "</td><td>" .$row2['CriminalID'] . "</td><td>" .$row2['Reward'] . "</td><td>" .$row2['PriorityStatus'] . "</td></tr>";  
                            }
