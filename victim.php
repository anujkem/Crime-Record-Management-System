        ...
        <div class="row text-white" id="welcomeBody">
           ...
           $dbname = "paisashu_crms";
                ...
                else
                {
                    ...
                    $sql1 = "SELECT P.Name,P.Adhaar,V.VictimID, V.CaseID,V.Status FROM victim V, person P WHERE P.Adhaar = V.Adhaar";
                    $result2 = $conn->query($sql1);
                    echo "<table>"; // start a table tag in the HTML
                    echo "<tr><th>Name</th><th>Adhaar Number</th><th>Victim ID</th><th>Case ID</th><th>Status</th></tr>";
                       while($row2 = $result2->fetch_assoc())
                       {   //Creates a loop to loop through results
                           
                        echo "<tr><td>" .$row2['Name'] . "</td><td>" .$row2['Adhaar'] . "</td><td>" .$row2['VictimID'] . "</td><td>" .$row2['CaseID'] . "</td><td>" .$row2['Status'] . "</td></tr>";  
                            }
